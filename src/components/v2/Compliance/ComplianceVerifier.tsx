        ...
        <div className="flex items-center gap-2">
          ...
          <span
            className={cn(
              ...
              complianceResult.grade === 'A' && 'bg-green-500',
              complianceResult.grade === 'B' && 'bg-emerald-500',
              complianceResult.grade === 'C' && 'bg-yellow-500',
              complianceResult.grade === 'D' && 'bg-orange-500',
              complianceResult.grade === 'F' && 'bg-red-500'
            )}
          >
