  ...
  return (
    <AnimatePresence>
      <motion.ul
        ...
        className="absolute z-50 flex max-h-[280px] w-64 flex-col overflow-y-auto rounded-lg border border-verde-200 bg-white shadow-xl"
        style={{
      ...
      >
        <li className="bg-verde-50 px-3 py-1.5 text-xs font-semibold text-verde-700">
            ...
            >
              <div
                className={cn(
                  ...
                  isSelected
                    ? 'border-verde-300 bg-white text-verde-700'
