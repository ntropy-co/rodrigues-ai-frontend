...
export function ChatArea({ messages, isStreaming, onRefresh }: ChatAreaProps) {
  ...
  return (
    <div
      ref={containerRef}
      className="relative flex-1 overflow-y-auto px-4 py-6 landscape:py-3 md:px-6"
    >
      ...
      {showScrollButton && (
        <button
          ...
          className="fixed bottom-24 right-6 z-10 flex h-11 w-11 items-center justify-center rounded-full bg-gemini-blue text-white shadow-lg transition-all active:scale-95 landscape:bottom-20 hover-hover:bg-gemini-blue-hover hover-hover:shadow-xl md:bottom-28 md:right-8"
          style={{
