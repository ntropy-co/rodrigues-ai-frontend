      ...
      <header className="flex h-16 w-full items-center justify-between px-4 py-2 md:h-20 md:px-6">
        ...
        <div className="flex w-10 justify-center">
          {ui.features.showProButton && (
            <button className="rounded-full bg-gradient-to-r from-gemini-blue to-gemini-purple px-3 py-1 text-sm font-medium text-white transition-all hover:from-gemini-blue-hover hover:to-gemini-purple">
              PRO
            </button>
          )}
        </div>
