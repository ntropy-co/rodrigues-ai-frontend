...
export function Header({
  ...
  return (
    <>
      <header
        className="sticky top-0 z-30 flex h-14 w-full items-center justify-between border-b border-sand-300/50 bg-sand-100/80 px-4 backdrop-blur-md dark:border-gray-800 dark:bg-card/80"
        role="banner"
      >
