      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <div className="space-y-2">
          ...
          >
            <SelectTrigger
              id="correction-index"
              className={errors.correctionIndex ? 'border-red-600' : ''}
        ...
        <div className="space-y-2">
          ...
          />
          {errors.issueDate && (
            <span className="text-xs text-red-500">{errors.issueDate}</span>
          )}
        </div>
        ...
        <div className="col-span-1 space-y-2 md:col-span-2">
          ...
          {errors.deliveryPlace && (
            <span className="text-xs text-red-500">{errors.deliveryPlace}</span>
          )}
        </div>
      </div>
