    ...
    <Card className={className}>
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Success Message */}
          {successMessage && (
            <div className="flex items-center gap-2 rounded-lg bg-verity-50 p-3 text-sm text-verity-700">
                ...
                {logoPreview ? (
                  <>
                    ...
                    <button
                      ...
                      className="absolute right-1 top-1 rounded-full bg-error-500 p-1 text-white transition-colors hover:bg-error-600"
