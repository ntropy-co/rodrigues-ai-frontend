...
> = {
  ...
  viewer: {
    ...
    color: 'bg-sand-200 text-verity-600 border-sand-300'
  }
}
...
const STATUS_CONFIG: Record<UserStatus, { label: string; color: string }> = {
  active: {
    label: 'Ativo',
    color: 'bg-verity-100 text-verity-700'
  },
  inactive: {
    label: 'Inativo',
    color: 'bg-sand-200 text-verity-500'
  },
  pending: {
    label: 'Pendente',
    color: 'bg-ouro-100 text-ouro-700'
  }
}
      ...
      <td className="px-4 py-3">
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-48">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem onClick={onDeactivate} className="text-error-600">
              <UserX className="mr-2 h-4 w-4" />
