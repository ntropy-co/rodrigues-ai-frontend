...
// In SidebarContent implementation:
...
// In Session mapping:
                <ConversationCard
                  ...
                  title={session.title}
                  timestamp={formatRelativeTime(new Date(session.created_at * 1000))}
                  preview=""
...
// In ConversationCardProps and Component:
              ...
              <div className="space-y-1">
                ...
                {projects.map((project) => (
                  <ConversationCard
                    ...
                    onViewDetails={() => (window.location.href = `/projects/${project.id}`)}
                  />
                ))}
              </div>
            )}
