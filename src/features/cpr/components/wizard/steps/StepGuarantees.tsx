    ...
    <div className="space-y-6 duration-300 animate-in fade-in slide-in-from-right-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          {GUARANTEE_OPTIONS.map((opt) => (
            ...
            >
              ...
              <label
                htmlFor={`g-${opt}`}
                className="w-full cursor-pointer text-sm font-medium leading-none text-verity-800 peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
              >
                {opt}
              </label>
            </div>
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          className={errors.guaranteeDescription ? 'border-error-500' : ''}
        />
          ...
          <div className="grid grid-cols-1 gap-4 border-l-2 border-muted pl-6 duration-200 animate-in fade-in zoom-in-95 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <Input
                ...
                className={errors.guarantorName ? 'border-error-500' : ''}
              />
