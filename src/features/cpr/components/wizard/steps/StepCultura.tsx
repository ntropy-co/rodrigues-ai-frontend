      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <div className="space-y-2">
          ...
          >
            <SelectTrigger
              id="commodity"
              className={errors.commodity ? 'border-error-500' : ''}
            >
          ...
          {errors.commodity && (
            <span className="text-xs text-error-500">{errors.commodity}</span>
          )}
        ...
        <div className="space-y-2">
          ...
          >
            <SelectTrigger
              id="safra"
              className={errors.safra ? 'border-error-500' : ''}
            >
          ...
          {errors.safra && (
            <span className="text-xs text-error-500">{errors.safra}</span>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            className={errors.expectedQuantity ? 'border-error-500' : ''}
          />
        ...
        <div className="space-y-2">
          ...
          >
            <SelectTrigger
              id="unit"
              className={errors.unit ? 'border-error-500' : ''}
            >
          ...
          {errors.unit && (
            <span className="text-xs text-error-500">{errors.unit}</span>
          )}
        </div>
