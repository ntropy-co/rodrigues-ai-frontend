...
import type { WorkflowType, WorkflowStep } from '@/features/cpr'
...
export function WorkflowProgressBar({
  ...
  return (
    <div className={cn('w-full space-y-3', className)}>
      {/* Progress bar */}
      <div className="relative h-2 w-full overflow-hidden rounded-full bg-sand-300">
        <motion.div
            ...
            >
              ...
              <motion.div
                className={cn(
                  ...
                  isPending && 'border-sand-400 bg-white text-verity-300'
                )}
                animate={{
